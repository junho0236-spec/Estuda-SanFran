...
import LargoAuction from './components/LargoAuction'; // Import
...
const App: React.FC = () => {
  ...
  const isCommunityChild = [View.Debate, View.ClassificadosPatio, View.JurisprudenceMural, View.Societies, View.Largo, View.StudyRoom, View.Mural, View.Mentorship, View.MockJury, View.PetitionWiki, View.StudyPact, View.LargoAuction].includes(currentView);
