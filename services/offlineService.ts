...
import { Flashcard, Task, StudySession, Note, SubjectFile, Folder, Subject } from '../types';

export interface OfflineSyncQueue {
  id?: number;
  table: 'flashcards' | 'tasks' | 'study_sessions' | 'notes' | 'subject_files' | 'folders' | 'subjects';
