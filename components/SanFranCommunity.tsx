    ...
    <div className="space-y-10 animate-in fade-in duration-700 pb-24 px-4 md:px-0 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 auto-rows-[minmax(180px,auto)]">
        ...
        <button
          ...
          className="group relative col-span-1 md:col-span-2 bg-[#ea580c] dark:bg-orange-950/40 rounded-[2.5rem] p-8 border border-orange-700 shadow-xl hover:shadow-orange-500/20 transition-all flex flex-col justify-between overflow-hidden"
        >
           <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cork-board.png')] opacity-10"></div>
           <div className="absolute top-0 left-0 w-64 h-64 bg-orange-400/20 rounded-full blur-3xl -ml-16 -mt-16 group-hover:scale-125 transition-transform"></div>

           <div className="flex justify-between items-start relative z-10">
              <div className="p-3 bg-orange-500/20 text-orange-200 rounded-2xl border border-orange-500/30 backdrop-blur-sm">
                 <Search size={24} />
              </div>
           ...
           <div className="text-left mt-8 relative z-10">
              <h4 className="text-2xl font-black text-white uppercase tracking-tight">Achados e Perdidos</h4>
              <p className="text-xs font-bold text-orange-200 uppercase tracking-widest mt-1">Mural Digital • Recuperação de Objetos</p>
           </div>
        </button>
        ...
        <button
          ...
          className="group relative col-span-1 md:col-span-2 bg-[#115e59] dark:bg-teal-950/40 rounded-[2.5rem] p-8 border border-teal-700 shadow-xl hover:shadow-teal-500/20 transition-all flex flex-col justify-between overflow-hidden"
        >
           <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/shattered-island.png')] opacity-10"></div>
           <div className="absolute top-0 right-0 w-64 h-64 bg-teal-400/20 rounded-full blur-3xl -mr-16 -mt-16 group-hover:scale-125 transition-transform"></div>
           ...
           <div className="text-left mt-8 relative z-10">
              <h4 className="text-2xl font-black text-white uppercase tracking-tight">Bússola de Optativas</h4>
              <p className="text-xs font-bold text-teal-200 uppercase tracking-widest mt-1">Reviews de Disciplinas • Guia de Matrícula</p>
           </div>
        </button>
        ...
        <button
          ...
          className="group relative col-span-1 md:col-span-2 bg-[#a16207] dark:bg-yellow-950/40 rounded-[2.5rem] p-8 border border-yellow-700 shadow-xl hover:shadow-yellow-500/20 transition-all flex flex-col justify-between overflow-hidden"
        >
           <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/clean-gray-paper.png')] opacity-10"></div>
           <div className="absolute top-0 right-0 w-64 h-64 bg-yellow-400/20 rounded-full blur-3xl -mr-16 -mt-16 group-hover:scale-125 transition-transform"></div>

           <div className="flex justify-between items-start relative z-10">
              <div className="p-3 bg-yellow-500/20 text-yellow-300 rounded-2xl border border-yellow-500/30 backdrop-blur-sm">
                 <Quote size={24} />
              </div>
              <ArrowUpRight size={20} className="text-yellow-200 group-hover:text-white transition-colors" />
           </div>
           <div className="text-left mt-8 relative z-10">
              <h4 className="text-2xl font-black text-white uppercase tracking-tight">Pérolas da Tribuna</h4>
              <p className="text-xs font-bold text-yellow-200 uppercase tracking-widest mt-1">Citações & Humor Acadêmico</p>
           </div>
        </button>
        ...
        <button
          ...
          className="group relative col-span-1 md:col-span-2 bg-[#047857] dark:bg-emerald-950/40 rounded-[2.5rem] p-8 border border-emerald-700 shadow-xl hover:shadow-emerald-500/20 transition-all flex flex-col justify-between overflow-hidden"
        >
           <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/p5.png')] opacity-10"></div>
           <div className="absolute top-0 left-0 w-64 h-64 bg-emerald-400/20 rounded-full blur-3xl -ml-16 -mt-16 group-hover:scale-125 transition-transform"></div>
           ...
           <div className="text-left mt-8 relative z-10">
              <h4 className="text-2xl font-black text-white uppercase tracking-tight">Guia de Sobrevivência</h4>
              <p className="text-xs font-bold text-emerald-200 uppercase tracking-widest mt-1">Mapa Colaborativo • Café, Almoço & Xerox</p>
           </div>
        </button>
        ...
        <button
          ...
          className="group relative col-span-1 md:col-span-2 bg-[#3f2e18] dark:bg-amber-950/50 rounded-[2.5rem] p-8 border border-amber-900/30 shadow-xl hover:shadow-amber-900/20 transition-all flex flex-col justify-between overflow-hidden"
        >
           <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/wood-pattern.png')] opacity-20"></div>
           <div className="absolute -right-10 -bottom-10 w-40 h-40 bg-amber-700/20 rounded-full blur-2xl animate-pulse"></div>

           <div className="flex justify-between items-start relative z-10">
              <div className="p-3 bg-amber-900/40 text-amber-200 rounded-2xl border border-amber-800/50 backdrop-blur-sm">
                 <BookType size={24} />
              </div>
              <ArrowUpRight size={20} className="text-amber-200 group-hover:text-white transition-colors" />
           </div>
           <div className="text-left mt-8 relative z-10">
              <h4 className="text-2xl font-black text-white uppercase tracking-tight">Clube do Livro</h4>
              <p className="text-xs font-bold text-amber-200/80 uppercase tracking-widest mt-1">Leitura Coletiva • Clássicos</p>
           </div>
        </button>
        ...
        <button
          ...
          className="group relative col-span-1 md:col-span-2 bg-[#9B111E] dark:bg-red-950/50 rounded-[2.5rem] p-8 border border-yellow-500/30 shadow-xl hover:shadow-red-500/20 transition-all flex flex-col justify-between overflow-hidden"
        >
           ...
           <div className="flex justify-between items-start relative z-10">
              <div className="p-3 bg-white/20 text-white rounded-2xl border border-white/20 backdrop-blur-sm">
                 <Trophy size={24} className="text-yellow-400" fill="currentColor" />
              </div>
              <ArrowUpRight size={20} className="text-yellow-200 group-hover:text-white transition-colors" />
           </div>
           <div className="text-left mt-8 relative z-10">
              <h4 className="text-2xl font-black text-white uppercase tracking-tight">Guerra das Turmas</h4>
              <p className="text-xs font-bold text-yellow-200 uppercase tracking-widest mt-1">Competição Coletiva • Pontos por Ano</p>
           </div>
        </button>
        ...
        <button
          ...
          className="group relative col-span-1 md:col-span-2 bg-[#4338ca] dark:bg-indigo-900/40 rounded-[2.5rem] p-8 border border-indigo-700 shadow-xl hover:shadow-indigo-500/20 transition-all flex flex-col justify-between overflow-hidden"
        >
           <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/diagmonds-light.png')] opacity-10"></div>
           <div className="absolute top-0 left-0 w-64 h-64 bg-orange-500/10 rounded-full blur-3xl -ml-16 -mt-16 group-hover:scale-125 transition-transform"></div>

           <div className="flex justify-between items-start relative z-10">
              <div className="p-3 bg-indigo-500/20 text-indigo-300 rounded-2xl border border-indigo-500/30 backdrop-blur-sm">
                 <Vote size={24} />
              </div>
              <ArrowUpRight size={20} className="text-indigo-200 group-hover:text-white transition-colors" />
           </div>
           <div className="text-left mt-8 relative z-10">
              <h4 className="text-2xl font-black text-white uppercase tracking-tight">Tribunal da Opinião</h4>
              <p className="text-xs font-bold text-indigo-200 uppercase tracking-widest mt-1">Enquetes Polêmicas • Veredito Popular</p>
           </div>
        </button>
