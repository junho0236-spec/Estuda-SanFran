  ...
  return (
    <div className="space-y-10 animate-in fade-in duration-700 pb-24 px-4 md:px-0 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 auto-rows-[minmax(180px,auto)]">
        ...
        {/* CARD 4: MENTORSHIP (Novo Card - Wide) */}
        <button
        ...
        {/* CARD 5: CLUBE DE DEBATES (Standard) */}
        <button
        ...
        {/* CARD 6: JURISPRUDÊNCIA (Standard) */}
        <button
        ...
        >
           ...
           <div className="text-left mt-4">
              ...
              <p className="text-[10px] font-bold text-slate-400 uppercase">Tribunal Simulado</p>
           </div>
        </button>

        {/* CARD 7: CLASSIFICADOS (Standard) */}
        <button
