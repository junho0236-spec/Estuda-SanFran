  ...
  return (
    <div className="space-y-10 animate-in fade-in duration-700 pb-24 px-4 md:px-0 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 auto-rows-[minmax(180px,auto)]">
        ...
        {/* CARD 3: BALCÃO DE ESTÁGIOS (Wide) */}
        <button
        ...
        {/* CARD 4: TRIBUNAL DA OPINIÃO (Wide) - NOVO */}
        <button
        ...
        {/* CARD 5: EVENTOS E ROLEZINHOS (Wide) */}
        <button
        ...
        {/* CARD 8: CARONAS E REPÚBLICAS (Wide) */}
        <button
        ...
        {/* CARD 11: THE VAULT (Banco de Provas) - (Tall) */}
        <button
        ...
        {/* CARD 13: JURISPRUDÊNCIA (Standard) */}
        <button
        ...
        {/* CARD 14: CLASSIFICADOS (Standard) */}
        <button
        ...
        {/* CARD 15: SOCIEDADES (Repetido/Atalho) */}
        <button
        ...
        >
           ...
           <div className="text-left mt-4">
              ...
              <p className="text-[10px] font-bold text-slate-400 uppercase">Grupos & Bancas</p>
           </div>
        </button>
