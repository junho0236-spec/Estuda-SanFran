...
import { 
  Search, Filter, Loader2, ShieldCheck, Star, FileDown, 
  Download, Eye, Link, Sparkles 
} from 'lucide-react';

interface AnkiCommunityProps {
  publicDecks: any[];
  communitySearch: string;
  setCommunitySearch: (val: string) => void;
  isFetchingCommunity: boolean;
  handleDownloadDeck: (deck: any) => void;
  setPreviewDeck: (deck: any) => void;
  setIsPreviewModalOpen: (val: boolean) => void;
  subjects: any[];
}

export const AnkiCommunity: React.FC<AnkiCommunityProps> = ({
  publicDecks,
  communitySearch,
  setCommunitySearch,
  isFetchingCommunity,
